                    ...
                    $indice=1;
                        foreach($anuncios->result() as $row){
                            ...
                            <tr>
                                ...
                                <td><?php echo 'R'.str_pad($indice,5,'0',STR_PAD_LEFT); ?></td>
                                ...
                                <td>
                                    <?php 
                                        echo form_open_multipart('anuncio/modificar_anuncio_admi');
                                    ?>
                                ...
                                <td>
                                    <?php 
                                        echo form_open_multipart('anuncio/eliminar_anuncio_admi');
                                    ?>
                                    <input type="hidden" name="idAnuncio" value="<?php echo $row->idAnuncio; ?>">
