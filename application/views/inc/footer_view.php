...
<footer class="text-center text-white final" style="background-color: #151748;">
  <!-- Grid container -->
  <div class="container pt-4">
    <!-- Section: Social media -->
    <section class="mb-3">
      <!-- Facebook -->
      <a class="btn btn-link btn-floating btn-lg text-light m-1" href="#!" role="button" data-mdb-ripple-color="light">
  ...
  <div class="text-center text-light p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    Instituto Nacional de Comercio "Federico Alvarez Plata" - 2021 
...
<script src="<?php echo base_url(); ?>bootstrap/js/anuncio.js"></script>
